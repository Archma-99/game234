...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget _buildWeatherContent() {
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          _buildHeader().animate().fadeIn(delay: 200.ms),
          const SizedBox(height: 24),
          _buildCurrentWeatherCard().animate().fadeIn(delay: 300.ms),
          const SizedBox(height: 24),
          _buildWeatherAdviceCard().animate().fadeIn(delay: 400.ms),
          const SizedBox(height: 24),
          _buildHourlyForecast().animate().fadeIn(delay: 500.ms),
          const SizedBox(height: 24),
          _buildDailyForecast().animate().fadeIn(delay: 600.ms),
          const SizedBox(height: 24),
          _buildWeatherDetailsGrid().animate().fadeIn(delay: 700.ms),
        ],
      ),
    );
  }
